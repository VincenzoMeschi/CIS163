...
class ChessModel:
  ...
  #debug
      # self.set_piece(0, 1, King(Player.BLACK))
      # self.set_piece(1, 1, Queen(Player.WHITE))
      # self.set_piece(1, 0, Queen(Player.WHITE))
      # self.set_piece(1, 2, Queen(Player.WHITE))
      # self.set_piece(0, 6, Rook(Player.WHITE))
